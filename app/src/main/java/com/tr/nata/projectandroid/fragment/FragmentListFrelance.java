...
//                });
    ...
    private void callApiAddNew(){
        ...
        int id_kecamatan = Integer.parseInt(String.valueOf(et_id_kecamatan.getText()));
...
//        Toast.makeText(AddJobActivity.this,"usia :"+usia,Toast.LENGTH_SHORT).show();
        ...
        service.newDataJasaUser(id_kategori,id_user,pekerjaan,estimasi_gaji,pengalaman_kerja,usia,no_telp,email,status,alamat,id_kecamatan)
